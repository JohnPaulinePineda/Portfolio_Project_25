...
# grouped by cancer
##################################
PC1_PC2_PC3_ScatterPlot <- cloud(PC1 ~ PC2*PC3,
      groups = EDA$Cancer,
       data = EDA,
       type = "p",
       pch = 16,
       ...
       main = "PC1 VERSUS PC2 VERSUS PC3 BY CANCER")

PC1_PC2_ScatterPlot <- xyplot(PC1 ~ PC2,
       groups = EDA$Cancer,
       data = EDA,
       xlab = "PC2",
       ylab = "PC1",
       ...
       alpha = 0.45,
       auto.key = list(points = TRUE, space = "top"),
       main = "PC1 VERSUS PC2 BY CANCER")

PC1_PC3_ScatterPlot <- xyplot(PC1 ~ PC3,
       groups = EDA$Cancer,
       data = EDA,
       xlab = "PC3",
       ylab = "PC1",
       ...
       alpha = 0.45,
       auto.key = list(points = TRUE, space = "top"),
       main = "PC1 VERSUS PC3 BY CANCER")

PC3_PC2_ScatterPlot <- xyplot(PC3 ~ PC2,
       groups = EDA$Cancer,
       data = EDA,
       xlab = "PC2",
       ylab = "PC3",
       ...
       alpha = 0.45,
       auto.key = list(points = TRUE, space = "top"),
       main = "PC2 VERSUS PC3 BY CANCER")

grid.arrange(PC1_PC2_PC3_ScatterPlot, 
             PC1_PC2_ScatterPlot,
             PC1_PC3_ScatterPlot,
             PC3_PC2_ScatterPlot,
             ncol = 2)
